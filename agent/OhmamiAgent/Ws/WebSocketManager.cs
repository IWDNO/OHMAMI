...
namespace OhmamiAgent.Ws
{
    public class WebSocketManager
    {
        ...
        public WebSocketManager(ILogger<WebSocketManager> logger, IConfiguration configuration)
        {
            this.logger = logger;
        ...
        public async Task HandleConnectionAsync(WebSocket ws, CancellationToken ct)
        {
            ...
            var senderTask = Task.Run(() => MetricsSenderLoop(ws, metricsCts.Token), metricsCts.Token);
